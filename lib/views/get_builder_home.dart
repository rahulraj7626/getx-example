...
class BuilderListingScreen extends StatefulWidget {
  const BuilderListingScreen({Key? key}) : super(key: key);

  @override
  State<BuilderListingScreen> createState() => _BuilderListingScreenState();
}

class _BuilderListingScreenState extends State<BuilderListingScreen> {
  TextEditingController controller =
      TextEditingController(); //define textcontroller
  final homeController = Get.put(BuilderController());
  //create object for homecontroller class
  void valfn() {
...
//remove button
            ...
            Expanded(
              //wrap with  GetBuilder init for initialize when first page load

              child: GetBuilder<BuilderController>(
                  init: BuilderController(),
                  builder: (controller) {
                    //cotroller instance of BuilderController can access variables and methods
                          ...
                          return Container(
                            ...
                            child: ListTile(
                              title: Text(controller.list[index],
                                  style: style(
                                      18, Colors.black54, FontWeight.w700)),
